...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
        <h4 class="card-title" style="padding: 16px;">{{ trans('reference.total_articles_stats') }}</h4>
                <div class="row">
...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
        <h5 class="card-title" style="padding: 16px;">{{ trans('reference.cited_articles_stats') }}</h5>
                <div class="row">
                    <div class="col-md-6 p-5">
                        <div style="width:520px;height:250px">

...
*** Test Cases ***
TC01_CSResearcher_FacultyTranslation
    ...
    Sleep    1s
    Click Element    xpath=//a[@class='dropdown-item' and contains(text(), 'Computer Science')]  # Click on the "Computer Science" item in the dropdown
    Sleep    2s
    Page Should Contain    text=Computer Science
    ...
    Page Should Contain    text=วิทยาการคอมพิวเตอร์
    ...
    Page Should Contain    text=计算机科学
...
*** Test Cases ***
TC02_CSResearcher_SearchTranslation

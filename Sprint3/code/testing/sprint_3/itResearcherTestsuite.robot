...
*** Test Cases ***
TC01_ITResearcher_FacultyTranslation
    ...
    Sleep    1s
    Click Element    xpath=//a[@class='dropdown-item' and contains(text(), 'Information Technology')]  # Click on the "Computer Science" item in the dropdown
    Sleep    2s
    Page Should Contain    text=Information Technology
    ...
    Page Should Contain    text=เทคโนโลยีสารสนเทศ
...
*** Test Cases ***
TC02_ITResearcher_SearchTranslation

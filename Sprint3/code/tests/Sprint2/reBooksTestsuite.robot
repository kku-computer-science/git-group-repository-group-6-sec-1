...
${VIEW_URL}             https://cs6sec267.cpkkuhost.com/books/15    # แก้ไขจากคำขอก่อนหน้า
${EDIT_URL}             https://cs6sec267.cpkkuhost.com/books/15/edit    # แก้ไขตามที่ระบุ
...
TC03_REBooks_View - ตรวจสอบภาษาข้อมูลในหน้ารายละเอียดของ UI16
    ...
    Go To    https://cs6sec267.cpkkuhost.com/books/15
...
TC05_REBook_FormEdit - ตรวจสอบภาษาของฟอร์มแก้ไข Books ของ UI16
    ...
    Go To    https://cs6sec267.cpkkuhost.com/books/15/edit

...
${CREATE_URL}           https://cs6sec267.cpkkuhost.com/patents/create
${VALID_PATENT_ID}      1    # เปลี่ยนเป็น ID ที่มีอยู่ในฐานข้อมูลจริง
${VIEW_URL}             https://cs6sec267.cpkkuhost.com/patents/${VALID_PATENT_ID}
${EDIT_URL}             https://cs6sec267.cpkkuhost.com/patents/${VALID_PATENT_ID}/edit

...
<script>
    $(document).ready(function() {
        var table1 = $('#example1').DataTable({
            ...
            columnDefs: [
                { targets: 1, width: '200px', render: $.fn.dataTable.render.ellipsis(30) }, // คอลัมน์ Name
                { targets: -1, width: '100px', orderable: false, responsivePriority: 1 }, // คอลัมน์ Action
                { targets: 0, width: '50px', render: $.fn.dataTable.render.ellipsis(5) }, // คอลัมน์ No
                { targets: 2, width: '80px', render: $.fn.dataTable.render.ellipsis(10) }, // คอลัมน์ Type
                { targets: 3, width: '100px', render: $.fn.dataTable.render.ellipsis(10) }, // คอลัมน์ Registration Date
                { targets: 4, width: '120px', render: $.fn.dataTable.render.ellipsis(20) }, // คอลัมน์ Registration Number
                { targets: 5, width: '150px', render: $.fn.dataTable.render.ellipsis(15) }, // คอลัมน์ Creator
            ],
            fixedHeader: true,
            scrollX: true,
            scrollCollapse: true,
        ...
        $('#example1').on('responsive-display', function (e, datatable, row, showHide, update) {
            if (showHide) {
                row.child().find('td').css('padding', '10px');
            }
        });
    });
</script>

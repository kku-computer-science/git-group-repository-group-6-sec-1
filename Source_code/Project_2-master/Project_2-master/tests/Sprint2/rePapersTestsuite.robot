...
*** Variables ***
${BROWSER}              chrome
${PAPERS_URL}           https://cs6sec267.cpkkuhost.com/papers
${CREATE_URL}           https://cs6sec267.cpkkuhost.com/papers/create
${VALID_PAPER_ID}       121
${VIEW_URL}             https://cs6sec267.cpkkuhost.com/papers/${VALID_PAPER_ID}
...
TC02_REPapers_Table - ตรวจสอบภาษาของตาราง Papers และข้อมูลในช่อง Type
    ...
    Should Be True    '${type_th}' in ['วารสาร', 'รายงานการประชุม', 'หนังสือชุด', 'หนังสือ']

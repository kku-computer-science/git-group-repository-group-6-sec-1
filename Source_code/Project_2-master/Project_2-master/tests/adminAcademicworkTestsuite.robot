...
Click Published Research
    Click Link    xpath=//a[contains(@href, '/patents')]
    Sleep    ${DELAY}
...
Click View Button
    Wait Until Element Is Visible    xpath=//a[contains(@href, '/patents') and contains(@class, 'btn-outline-primary')]    timeout=5s
    Click Link    xpath=//a[contains(@href, '/patents') and contains(@class, 'btn-outline-primary')]
    Sleep    ${DELAY}
...
Click Back Button
    Wait Until Element Is Visible    xpath=//a[contains(@href, '/patents') and contains(@class, 'btn-primary')]    timeout=5s
    Click Link    xpath=//a[contains(@href, '/patents') and contains(@class, 'btn-primary')]
    Sleep    ${DELAY}

Click to new page
    Click Link    xpath=//a[contains(@href, '/patents/create') and contains(@class, 'btn-primary')]
    Sleep    ${DELAY}
